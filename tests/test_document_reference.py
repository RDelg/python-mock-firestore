...
class TestDocumentReference(TestCase):
    ...
    def test_document_update_firestore_transformerIncrementBasic(self):
        fs = MockFirestore()
    ...
    def test_document_update_firestore_transformerIncrementNested(self):
        fs = MockFirestore()
        fs._data = {"foo": {"first": {"nested": {"count": 1}, "other": {"likes": 0},}}}
    ...
    def test_document_update_firestore_transformerIncrementNonExistent(self):
        fs = MockFirestore()
    ...
    def test_document_update_firestore_transformerArrayUnionBasic(self):
        fs = MockFirestore()
    ...
    def test_document_update_firestore_transformerArrayUnionNested(self):
        fs = MockFirestore()
        fs._data = {
            "foo": {"first": {"nested": {"arr": [1]}, "other": {"labels": ["a"]},}}
        }
        fs.collection("foo").document("first").update(
            {
    ...
    def test_document_update_firestore_transformerArrayUnionNonExistent(self):
        fs = MockFirestore()
        fs._data = {"foo": {"first": {"spicy": "tuna"}}}
        fs.collection("foo").document("first").update(
    ...
    def test_document_update_transformerArrayUnionBasic(self):
        fs = MockFirestore()
        fs._data = {"foo": {"first": {"arr": [1, 2]}}}
        fs.collection("foo").document("first").update({"arr": ArrayUnion([3, 4])})
        doc = fs.collection("foo").document("first").get().to_dict()
        self.assertEqual(doc["arr"], [1, 2, 3, 4])
    ...
    def test_document_update_transformerArrayUnionNested(self):
        ...
        fs.collection("foo").document("first").update(
            {
                "nested": {"arr": ArrayUnion([2])},
                "other": {"labels": ArrayUnion(["b"]), "smoked": "salmon"},
            }
        )
    ...
    def test_document_update_transformerArrayUnionNonExistent(self):
        fs = MockFirestore()
        fs._data = {"foo": {"first": {"spicy": "tuna"}}}
        fs.collection("foo").document("first").update({"arr": ArrayUnion([1])})
    ...
    def test_document_update_transformerIncrementBasic(self):
        fs = MockFirestore()
        fs._data = {"foo": {"first": {"count": 1}}}
        fs.collection("foo").document("first").update({"count": Increment(2)})
    ...
    def test_document_update_transformerIncrementNested(self):
        ...
        fs.collection("foo").document("first").update(
            {
                "nested": {"count": Increment(-1)},
                "other": {"likes": Increment(1), "smoked": "salmon"},
            }
        )
    ...
    def test_document_update_transformerIncrementNonExistent(self):
        fs = MockFirestore()
        fs._data = {"foo": {"first": {"spicy": "tuna"}}}
        fs.collection("foo").document("first").update({"count": Increment(1)})
    ...
    def test_document_update_transformerArrayRemoveBasic(self):
        fs = MockFirestore()
        fs._data = {"foo": {"first": {"arr": [1, 2]}}}
        fs.collection("foo").document("first").update({"arr": ArrayRemove([1, 4])})
        doc = fs.collection("foo").document("first").get().to_dict()
        self.assertEqual(doc["arr"], [2])

    def test_document_update_transformerArrayRemoveNested(self):
        fs = MockFirestore()
        fs._data = {
            "foo": {"first": {"nested": {"arr": [1, 2]}, "other": {"labels": ["a", "b"]},}}
        }
        fs.collection("foo").document("first").update(
            {
                "nested": {"arr": ArrayRemove([2])},
                "other": {"labels": ArrayRemove(["b"]), "smoked": "salmon"},
            }
        )
    ...
    def test_document_update_transformerArrayRemoveNonExistent(self):
        fs = MockFirestore()
        fs._data = {"foo": {"first": {"spicy": "tuna"}}}
        fs.collection("foo").document("first").update({"arr": ArrayRemove([1])})

        doc = fs.collection("foo").document("first").get().to_dict()
        self.assertEqual(doc, {"arr": [], "spicy": "tuna"})

    def test_document_update_transformerMaximumBasic(self):
        fs = MockFirestore()
        fs._data = {"foo": {"first": {"count": 10, "likes": 5}}}
        fs.collection("foo").document("first").update(
            {"count": Maximum(9), "likes": Maximum(100)}
        )
        doc = fs.collection("foo").document("first").get().to_dict()
        self.assertEqual(doc, {"count": 10, "likes": 100})

    def test_document_update_transformerMaximumNonExisting(self):
        fs = MockFirestore()
        fs._data = {"foo": {"first": {"smoked": "salmon"}}}
        fs.collection("foo").document("first").update({"likes": Maximum(100)})
        doc = fs.collection("foo").document("first").get().to_dict()
        self.assertEqual(doc, {"smoked": "salmon", "likes": 100})

    def test_document_update_transformerMaximumStoredValueNonNumeric(self):
        fs = MockFirestore()
        fs._data = {"foo": {"first": {"smoked": "salmon"}}}
        fs.collection("foo").document("first").update({"smoked": Maximum(100)})
        doc = fs.collection("foo").document("first").get().to_dict()
        self.assertEqual(doc, {"smoked": 100})

    def test_document_update_transformerMinimumBasic(self):
        fs = MockFirestore()
        fs._data = {"foo": {"first": {"count": 10, "likes": 5}}}
        fs.collection("foo").document("first").update(
            {"count": Minimum(9), "likes": Minimum(100)}
        )
        doc = fs.collection("foo").document("first").get().to_dict()
        self.assertEqual(doc, {"count": 9, "likes": 5})

    def test_document_update_transformerMinimumNonExisting(self):
        fs = MockFirestore()
        fs._data = {"foo": {"first": {"smoked": "salmon"}}}
        fs.collection("foo").document("first").update({"likes": Minimum(100)})
        doc = fs.collection("foo").document("first").get().to_dict()
        self.assertEqual(doc, {"smoked": "salmon", "likes": 100})

    def test_document_update_transformerMinimumStoredValueNonNumeric(self):
        fs = MockFirestore()
        fs._data = {"foo": {"first": {"smoked": "salmon"}}}
        fs.collection("foo").document("first").update({"smoked": Minimum(100)})
        doc = fs.collection("foo").document("first").get().to_dict()
        self.assertEqual(doc, {"smoked": 100})
